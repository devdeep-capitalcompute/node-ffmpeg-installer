...
var packageName = '@devdeep-ffmpeg-installer/' + platform;
...
var topLevelPath = path.resolve(__dirname.substr(0, __dirname.indexOf('node_modules')), 'node_modules', '@devdeep-ffmpeg-installer', platform);
var npm3Path = path.resolve(__dirname, '..', platform);
var npm2Path = path.resolve(__dirname, 'node_modules', '@devdeep-ffmpeg-installer', platform);
